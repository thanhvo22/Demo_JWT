...
module.exports = {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, account_model_1["default"].findOne(user)];
                case 1:
                    findUser = _b.sent();
                    if (findUser)
    ...
    putUser: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _id, _a, user, name_2, pass, hashedPass, newUser, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 3, , 4]);
                    _id = req.params.id;
                    _a = req.body, user = _a.user, name_2 = _a.name, pass = _a.pass;
                    return [4 /*yield*/, argon2.hash(pass)];
                case 1:
                    hashedPass = _b.sent();
                    return [4 /*yield*/, account_model_1["default"].findByIdAndUpdate(_id, {
                            user: user,
                            name: name_2,
                            pass: hashedPass
                        })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    _id = req.params.id;
                    return [4 /*yield*/, account_model_1["default"].findByIdAndRemove({ id: _id })];
                case 1:
                    newUser = _a.sent();
                    res.status(201).json({
